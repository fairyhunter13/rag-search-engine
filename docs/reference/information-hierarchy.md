...
Defined from redacted-name-10's gold-standard exemplar (`docs/information-hierarchy/`):
...
| redacted-name-10-project `docs/information-hierarchy/` (human-authored, June 2026) | Gold-standard exemplar: per-domain importance/generality spines, canonical 5-section order, every claim `[code: file:line]` grounded. |

...
| the astro-frontmatter call gap | **recorded and consciously deferred**, in `2026-07-31-call-extraction-skips-injections-deliberately.md` §"What is genuinely missing" — 0 fleet files, and it needs a code-family filter on injected languages first |

...
Rebuilds in dependency order:
  1. All non-federation standalone projects (OSE, redacted-name-0, astro members)
  2. The federation root (redacted-name-3) last — its L3/BPRE depend on member enrichment
"""

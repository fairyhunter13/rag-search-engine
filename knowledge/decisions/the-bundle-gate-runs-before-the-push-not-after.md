...
CI does run it, but a CI gate answers after the change is on the remote. For a bundle whose whole
purpose is to be read by the next session, "the push is already public and the bundle is wrong"

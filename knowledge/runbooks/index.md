...
* [Running anything that touches the real GPU](running-the-live-suite.md) - Two preconditions, a
  clear lock and ≥10 GiB free VRAM. Also the one-at-a-time rule, and the switch that separates
  starting the daemon from starting an overnight fleet index.

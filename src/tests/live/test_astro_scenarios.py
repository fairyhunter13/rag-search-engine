"""Comprehensive real-world scenario tests for redacted-name-3.
...
class TestAstroDebugging:
    ...
    def test_goroutine_panic_debug(self, http, astro):
        ...
        answer, intent, *_ = _chat(
            ...
            "github.com/example-org/acme-campaign-be/service.(*CampaignService).GetCampaignByID(...)\n"
            "\t/home/runner/work/acme-campaign-be/service/campaign.go:187 +0x3b2\n"
    ...
    def test_nil_pointer_cart_investigation(self, http, astro):
        ...
        answer, intent, *_ = _chat(
            http, astro,
            "I got a nil pointer dereference panic in acme-cart-be/service/cart.go. "

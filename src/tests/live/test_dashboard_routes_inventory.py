...
_ROUTES: list[tuple[str, str, dict | None]] = [
    ...
    ("/api/prerelease_status", "GET", None),
    ("/api/run_prerelease", "POST", {"project": "/tmp/does-not-exist"}),
    ("/api/prerelease_poll", "GET", None),
    ("/api/verify_status", "GET", None),
    ("/api/auto_fix_trigger", "POST", {"project": "/tmp/does-not-exist"}),
    ("/api/qa_status", "GET", None),
    ("/api/run_qa", "POST", {"project": "/tmp/does-not-exist"}),
    ("/api/qa_poll", "GET", None),

...
from rag_search.kb.valueflow import build_def_use, build_type_use, resolve_first_arg, _t as _vt
from rag_search.kb.bpre_spec import _FIRST_CLASS, _IMPORT_KINDS
from rag_search.kb.bpre_generic import scan_generic
@dataclass
class FileFacts:
    path:str
...
def federation_discover(members:list[str])->ApiSurface:
    ...
    from rag_search.core.config import IGNORED_DIRS
    from rag_search.core.index_config import effective_config, is_excluded

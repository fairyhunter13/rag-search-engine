...
- Centralized indexes live under `~/.local/share/opencode-search/indexes/<project-slug>-<hash>/index_<tier>/` by default; removing that directory and running `index --force` is the clean rebuild path.

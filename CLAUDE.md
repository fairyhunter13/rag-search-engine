...
learn: `docs/decisions/`. The short ids everything here cites — `AU5`, `RL2`, `SC9`, `HR10` —
resolve to their defining guard in `docs/reference/invariant-ids.md`, generated by
`scripts/gen_invariant_ids.py` and gated by `test_invariant_id_index_is_current`.
